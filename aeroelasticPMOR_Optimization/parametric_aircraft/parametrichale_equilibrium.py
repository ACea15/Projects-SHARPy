# Code to perform the aeroelastic equilibrium at various angles of attack
...
try:
    model_route = os.path.dirname(os.path.realpath(__file__)) + '/aoa_equilibrium'
except:
    import inspect

    __file__ = inspect.getfile(lambda: None)
    model_route = os.path.dirname(__file__) + '/aoa_equilibrium'
...
####### ... or do full aircraft #########
g1 = gm.Model('sharpy', ['sharpy'],
              model_dict=model_settings('aoa_%s' %AoA_deg),
