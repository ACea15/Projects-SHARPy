...
# using AoA and AR as design parameters but with a stiff bending stiffness
# The rest of parameters are kept constant: Uinf = 10m/s; taper=1; twist=0deg; Payload mass position?;
# eiy = 2e6 (changed from original code)
# Date first created: 27/04/22
