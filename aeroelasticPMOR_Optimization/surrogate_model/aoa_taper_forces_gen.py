# Script to generate the data for a 2D surrogate model for lift, drag and pitching moment
# using AoA and taper as design parameters.
# The rest of parameters are kept constant: Uinf = 10m/s; AR=32; twist=0deg; EIy = 2e4;

# Date first created: 28/04/22
...
# Check what would happen if alternate definition of wing span is used (The one which takes the projected length)
