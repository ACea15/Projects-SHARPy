# Code to obtain flutter speed for varying AR
# Date of start: 05/04/22
...
for i in range(len(AR)):
    ...
    if os.path.exists(file2check):
        ...
        os.chdir('./'+foldername+'/'+foldername+'_%s' %int(AR[i]))
        data = sharpy.sharpy_main.main(['', foldername+'_%s.sharpy' %int(AR[i])])
