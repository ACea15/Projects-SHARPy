# Code to test the flutter speed solution:
# Constants:
# AoA = 1.2 deg, AR = 32, Uinf = 10m/s and ex = 0.23
...
ex_values = np.linspace(0.2,0.38,7)
ex = np.array([ex_values[1],])
